...
// ETERM*
// find(state_t* state, ErlMessage* emsg, ETERM* html_term, ETERM* selector_term, ETERM* delimiter_term)
// {
...
//   char* delimiter_string = (char*)ERL_BIN_PTR(delimiter_term);
//   size_t delimiter_string_len = ERL_BIN_SIZE(delimiter_term);
